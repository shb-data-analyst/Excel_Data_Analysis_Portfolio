...
The datasets are intentionally designed to include missing customer records to simulate real-world data challenges.
...
## Business Insights
- Key cities contribute the majority of total sales.
- Certain products generate significantly higher revenue compared to others.
- Monthly sales trends show variation, indicating potential seasonality.
- Orders without matching customer data were identified and handled professionally.
